...
float Processor::Utilization() { 
        ...
        double user_n,nice_n,system_n,idle_n,iowait_n,irq_n,softirq_n,steal_n;//,guest_n,guest_nice_n;
        ...
        double nonIdle = user_n+nice_n+system_n+irq_n+softirq_n+steal_n;
